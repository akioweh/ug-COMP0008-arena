...
> **OO "Thread Objects"** — Oracle Java Tutorial on thread creation and management (online reference, not extracted from PDF)

> **OO "Synchronization"** — Oracle Java Tutorial on synchronization mechanisms (online reference, not extracted from PDF)

**GPBBHL 1.4 — Threads are Everywhere**
